...
class Seeker():
    ...
    def __init__(self, row ) -> None:
        ...
        self.expected_pooling_passenger_ride_distance_for_taker = row.taker_expect_ride_distance_for_taker
        self.expected_pooling_passenger_ride_distance_for_seeker = row.taker_expect_ride_distance_for_seeker
        self.expected_pooling_driver_ride_distance_for_taker = row.driver_expect_ride_distance_for_taker
        self.expected_pooling_driver_ride_distance_for_seeker = row.driver_expect_ride_distance_for_seeker
        self.waitingWeight = 0
        self.soloWeight = 0
        self.matchingWeight = 0
        self.random_seed = 1
        self.waitingtime_threshold = 60
