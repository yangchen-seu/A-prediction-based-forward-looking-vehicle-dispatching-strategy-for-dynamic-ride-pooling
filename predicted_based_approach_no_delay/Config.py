...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.order_file= '../input/one_month_demand_rate/order.csv' 
        ...
        self.optimazition_target = 'expected_shared_distance' # platform_income, expected_shared_distance,combination
