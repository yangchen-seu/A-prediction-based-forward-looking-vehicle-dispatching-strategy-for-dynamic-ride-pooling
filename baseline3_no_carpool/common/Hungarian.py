...
class Hungarian:
    ...
    def get_dic_results(self):
        ...
        for i in range(len(self._results)):
            res[self._results[i][0]] = self._results[i][1]
        return  res
    ...
    def calculate(self, input_matrix=None, is_profit_matrix=False):
        ...
        while len(self._results) != expected_results:
            ...
            if not zero_locations.any():
                print('len(self._results),',len(self._results), self._results)
...
#     print("Results:\n\t", hungarian.get_results())
#     print(' hungarian.get_results()', hungarian.get_results()[0])
#     print(' hungarian.get_results()', hungarian.get_results()[0][1])
